...
function isRegExp$1 (v) {
  return _toString$2.call(v) === '[object RegExp]'
}
...
function toString (val) {
  return val == null
    ? ''
    : Array.isArray(val) || (isPlainObject(val) && val.toString === _toString$2)
...
let len, str$1, chr, index$1, expressionPos, expressionEndPos;
